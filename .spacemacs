...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(ansible
     ...
     yaml
     ;;(mu4e :variables
     ;;      mu4e-installation-path "/usr/local/Cellar/mu/1.2.0/share/emacs/site-lisp/mu/mu4e")
     )
...
;;    :defer t)
  ...
  (setq org-bullets-bullet-list (quote ("✺" "✹" "✸" "✷" "✶" "✭" "✦" "■" "▲" "●"))
        ...
        '(("TODO" . (:foreground "chocolate2" :weight bold))
          ("NEXT" . (:foreground "DeepSkyBlue1" :weight bold))
          ("PROGRESS" . (:foreground "chocolate1" :weight bold))
          ("DONE" . (:foreground "chartreuse3" :weight bold))
          ("WAITING" . (:foreground "DarkOrange1" :weight bold))
          ("HOLD" . (:foreground "plum1" :weight bold))
          ("CANCELLED" . (:foreground "gold" :weight bold)))))
...
;;     '(("smtp.gmail.com" 587 "sebastien.hurtel@blade-group.com" nil))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (uuid junos-mode quelpa-use-package quelpa epl git commander s flycheck-elsa cask ansi package-build shut-up company-quickhelp flx bind-key dash-functional hydra f git-commit evil company avy dash websocket smartparens lv pythonic ox-gfm request yasnippet with-editor async anaconda-mode flycheck helm helm-core projectile org-plus-contrib magit transient simple-httpd yasnippet-snippets define-word yapfify yaml-mode xterm-color ws-butler winum which-key web-mode web-beautify volatile-highlights vi-tilde-fringe uuidgen use-package unfill toc-org tagedit spaceline smeargle slim-mode shell-pop scss-mode sass-mode reveal-in-osx-finder restart-emacs rainbow-delimiters pyvenv pytest pyenv-mode py-isort pug-mode popwin pip-requirements persp-mode pcre2el pbcopy paradox osx-trash osx-dictionary orgit org-projectile org-present org-pomodoro org-mime org-download org-bullets open-junk-file neotree mwim multi-term move-text mmm-mode markdown-toc magit-gitflow macrostep lorem-ipsum livid-mode live-py-mode linum-relative link-hint launchctl json-mode js2-refactor js-doc jinja2-mode indent-guide hy-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers highlight-indentation helm-themes helm-swoop helm-pydoc helm-projectile helm-mode-manager helm-make helm-gitignore helm-flx helm-descbinds helm-css-scss helm-company helm-c-yasnippet helm-ag google-translate golden-ratio gnuplot gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gh-md fuzzy flyspell-correct-helm flycheck-pos-tip flx-ido fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help emmet-mode elisp-slime-nav ein dumb-jump diminish diff-hl cython-mode csv-mode company-web company-tern company-statistics company-ansible company-anaconda column-enforce-mode coffee-mode clean-aindent-mode auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile ansible-doc ansible aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
